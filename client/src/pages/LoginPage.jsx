  ...
  const handleSubmit = async (e) => {
    ...
    if(vaidateForm()) {
      axios.post('/auth/login', {
          ...
          localStorage.setItem('login-token', response.data.dataToken);
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '50vh' }}>
      ...
      <div className="input-container">
        ...
        />
          <input type="email" value={useremail}  placeholder='Enter Email' onChange={(e) => setUseremail(e.target.value)} />
        </div>
      </div>
      <div className="input-container">
